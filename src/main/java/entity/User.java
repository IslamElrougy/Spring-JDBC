...
public class User  implements java.io.Serializable {
    ...
    {
        return "User{" + "id=" + id + ", email=" + email + ", address=" + address + ", phone=" + phone + ", mobile=" + mobile + ", dateOfBirth=" + dateOfBirth + ", registrationDate=" + registrationDate + ", userName=" + userName + ", password=" + password + ", fullName=" + fullName + '}';
    }
